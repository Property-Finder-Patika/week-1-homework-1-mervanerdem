/*
Following the approach of the Lissajous example in Sec tion 1.7, construct a web
server that computes surfaces and writes SVG dat a to the client. The server must set the Content-Type header like this:
...
func main() {
	fmt.Println("For open the result write in your browser `localhost:8080`")
